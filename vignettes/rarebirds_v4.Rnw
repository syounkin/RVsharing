...
candidate.genes = scan("~syounkin/R/packages/Bureau/inst/extdata/candidate.genes.txt", what=character(), skip=1)
@
...
<<read ped data>>=
# Reading in the data
ocped = read.csv2("~syounkin/R/packages/Bureau/inst/extdata/germ_pitts_tw_iowa_syr_pedigree_jbh.csv")
...
ocaffected.inferedkin = read.table("~syounkin/R/packages/Bureau/inst/extdata/oc_cleaned05_related.kin",header=T)
...
oc.pshare = sapply(ped.tocompute,Bureau:::RVsharing.ped.pshare)
...
german.fams = scan("~syounkin/R/packages/Bureau/inst/extdata/german.fams.txt")
...
indian.fams = scan("~syounkin/R/packages/Bureau/inst/extdata/indian.fams.txt")
...
filipino.fams = scan("~syounkin/R/packages/Bureau/inst/extdata/filipino.fams.txt")
...
syrian.fams = scan("~syounkin/R/packages/Bureau/inst/extdata/syrian.fams.txt")
